<?php 
    ...
    $sql .= "where last_ship_date<'{$last_ship_date}' and cust.phone is not null and len(cust.phone)=14 and cust.country='001' and ctype in ('r','') ";
...
//      print_r($row);
        ...
        foreach($row as $key=>$value) {
            ...
            $stmt2 = $db->query($sql);
			$items = array();
            while ($row2 = $db->fetch_array($stmt2)) {
